...
1. Скачать с сайта Haiku-OS.org [ISO anyboot 64-битный образ](https://mirrors.rit.edu/haiku/r1beta6/haiku-r1beta6-x86_64-anyboot.iso). Он не грузится на современных компьютерах с UEFI-Only BIOS, поэтому необходимо создать свой образ с таблицей GPT и разделом содержащим 64-х битный UEFI загрузчик.
...
1. Скачать с сайта Haiku-OS.org [ISO anyboot 32-битный образ](https://mirrors.rit.edu/haiku/r1beta6/haiku-r1beta6-x86_gcc2h-anyboot.iso). Он не грузится на многих старых компьютерах, для этого надо создать свой образ с таблицей разделов MBR содеращей MBR и VBR загрузчики.
